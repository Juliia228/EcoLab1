...
typedef struct CEcoLab1_F0B7954C {
...
} CEcoLab1_F0B7954C, *CEcoLab1_F0B7954CPtr;

/* Инициализация экземпляра */
int16_t ECOCALLMETHOD initCEcoLab1_F0B7954C(/*in*/ struct IEcoLab1* me, /* in */ IEcoUnknown *pIUnkSystem);
/* Создание экземпляра */
